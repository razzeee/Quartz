...
--				else
				if anchor == "target" and Target.Bar then
				...
				args = {
					...
					bars = {
						...
						args = {
							...
							BREATH = {
								type = "color",
								name = format(L["%s Color"],L["Breath"]),
								desc = format(L["Set the color of the bars for %s"],L["Breath"]),
								get = getColor,
								set = setColor,
							...
							EXHAUSTION = {
								type = "color",
								name = format(L["%s Color"],L["Exhaustion"]),
								desc = format(L["Set the color of the bars for %s"],L["Exhaustion"]),
								get = getColor,
								set = setColor,
								disabled = getmirrorhidden,
								order = 101,
							...
							FEIGNDEATH = {
								type = "color",
								name = format(L["%s Color"],L["Feign Death"]),
								desc = format(L["Set the color of the bars for %s"],L["Feign Death"]),
								get = getColor,
								set = setColor,
								disabled = getmirrorhidden,
								order = 101,
							...
							CAMP = {
								type = "color",
								name = format(L["%s Color"],L["Logout"]),
								desc = format(L["Set the color of the bars for %s"],L["Logout"]),
								get = getColor,
								set = setColor,
							...
							DEATH = {
								type = "color",
								name = format(L["%s Color"],L["Release"]),
								desc = format(L["Set the color of the bars for %s"],L["Release"]),
								get = getColor,
								set = setColor,
								disabled = getstatichidden,
								order = 201,
							...
							QUIT = {
								type = "color",
								name = format(L["%s Color"],L["Quit"]),
								desc = format(L["Set the color of the bars for %s"],L["Quit"]),
								get = getColor,
								set = setColor,
								disabled = getstatichidden,
								order = 201,
							...
							DUEL_OUTOFBOUNDS = {
								type = "color",
								name = format(L["%s Color"],L["Forfeit Duel"]),
								desc = format(L["Set the color of the bars for %s"],L["Forfeit Duel"]),
								get = getColor,
								set = setColor,
								disabled = getstatichidden,
								order = 201,
							...
							INSTANCE_BOOT = {
								type = "color",
								name = format(L["%s Color"],L["Instance Boot"]),
								desc = format(L["Set the color of the bars for %s"],L["Instance Boot"]),
								get = getColor,
								set = setColor,
								disabled = getstatichidden,
								order = 201,
							...
							CONFIRM_SUMMON = {
								type = "color",
								name = format(L["%s Color"],L["Summon"]),
								desc = format(L["Set the color of the bars for %s"],L["Summon"]),
								get = getColor,
								set = setColor,
								disabled = getstatichidden,
								order = 201,
							...
							AREA_SPIRIT_HEAL = {
								type = "color",
								name = format(L["%s Color"],L["AOE Rez"]),
								desc = format(L["Set the color of the bars for %s"],L["AOE Rez"]),
								get = getColor,
								set = setColor,
								disabled = getstatichidden,
								order = 201,
							...
							REZTIMER = {
								type = "color",
								name = format(L["%s Color"],L["Resurrect Timer"]),
								desc = format(L["Set the color of the bars for %s"],L["Resurrect Timer"]),
								get = getColor,
								set = setColor,
								disabled = getstatichidden,
								order = 201,
							...
							RESURRECT_NO_SICKNESS = {
								type = "color",
								name = format(L["%s Color"],L["Resurrect"]),
								desc = format(L["Set the color of the bars for %s"],L["Resurrect"]),
								get = getColor,
								set = setColor,
								disabled = getstatichidden,
								order = 201,
							...
							PARTY_INVITE = {
								type = "color",
								name = format(L["%s Color"],L["Party Invite"]),
								desc = format(L["Set the color of the bars for %s"],L["Party Invite"]),
								get = getColor,
								set = setColor,
								disabled = getstatichidden,
								order = 201,
							...
							DUEL_REQUESTED = {
								type = "color",
								name = format(L["%s Color"],L["Duel Request"]),
								desc = format(L["Set the color of the bars for %s"],L["Duel Request"]),
								get = getColor,
								set = setColor,
								disabled = getstatichidden,
								order = 201,
							...
							GAMESTART = {
								type = "color",
								name = format(L["%s Color"],L["Game Start"]),
								desc = format(L["Set the color of the bars for %s"],L["Game Start"]),
								get = getColor,
								set = setColor,
							...
							READYCHECK = {
								type = "color",
								name = format(L["%s Color"],READY_CHECK),
								desc = format(L["Set the color of the bars for %s"],READY_CHECK),
								get = getColor,
								set = setColor,
